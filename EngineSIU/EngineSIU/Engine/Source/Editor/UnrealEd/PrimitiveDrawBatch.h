...
public:
    ...
    void UpdateLinePrimitiveCountBuffer(int NumBoundingBoxes, int NumCones,int NumSpheres) const;
    ...
    void AddSphereToBatch(const FVector& Center, float Radius, int Segments, const FVector4& Color);
